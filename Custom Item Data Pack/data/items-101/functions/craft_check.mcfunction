...
execute if score generic_item2 list matches 1 run execute if block ~3 ~1 ~-2 chest{Items:[{id:"minecraft:wooden_hoe",Count:1b,tag:{Damage:0}}]} run function items-101:user_items/generic/item2

execute if score generic_item3 list matches 1 run execute if block ~3 ~1 ~-2 chest{Items:[{id:"minecraft:sheild",Count:1b,tag:{Damage:0}}]} run function items-101:user_items/generic/item3
