...
execute unless score @s adder matches 0 store result score @s count run data get entity @s HandItems[0].tag.tags[{id:"spruce_logs"}].Count
execute store result entity @s HandItems[0].tag.tags[{id:"spruce_logs"}].Count double 1 run scoreboard players operation @s count += @s adder
