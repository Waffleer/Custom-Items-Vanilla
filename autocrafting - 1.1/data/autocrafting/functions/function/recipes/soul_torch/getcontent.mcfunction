...
#Tag: autocrafting_coal
execute as @s at @s run function autocrafting:function/tags/autocrafting_coal/getcontent

#Tag: soul_fire_base_blocks
execute as @s at @s run function autocrafting:function/tags/soul_fire_base_blocks/getcontent
